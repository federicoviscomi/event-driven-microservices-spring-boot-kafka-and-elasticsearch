...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        LOG.info("com.microservices.demo.kafka.consumer.config.KafkaConsumerConfig.consumerConfigs+");
        ...
        LOG.info("com.microservices.demo.kafka.consumer.config.KafkaConsumerConfig.consumerConfigs- " + props);
        return props;
    }

    @Bean
    public ConsumerFactory<K, V> consumerFactory() {
        LOG.info("com.microservices.demo.kafka.consumer.config.KafkaConsumerConfig.consumerFactory+");
        DefaultKafkaConsumerFactory<K, V> kvDefaultKafkaConsumerFactory = new DefaultKafkaConsumerFactory<>(consumerConfigs());
        LOG.info("com.microservices.demo.kafka.consumer.config.KafkaConsumerConfig.consumerFactory- " + kvDefaultKafkaConsumerFactory);
        return kvDefaultKafkaConsumerFactory;
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<K, V>> kafkaListenerContainerFactory() {
        LOG.info("com.microservices.demo.kafka.consumer.config.KafkaConsumerConfig.kafkaListenerContainerFactory+");
        ...
        LOG.info("com.microservices.demo.kafka.consumer.config.KafkaConsumerConfig.kafkaListenerContainerFactory- " + factory);
        return factory;
    }
}
